...
_OBJ = Main.o NetUtils.o XL3Link.o GenericLink.o ControllerLink.o XL3Cmds.o Globals.o XL3Model.o DB.o DetectorDB.o Json.o Pouch.o MTCLink.o MTCCmds.o MTCModel.o FECTest.o MemTest.o BoardID.o CaldTest.o CGTTest.o ChinjScan.o CrateCBal.o DiscCheck.o FifoTest.o GTValidTest.o MbStabilityTest.o PedRun.o SeeReflection.o SeeReflectionEsum.o TriggerScan.o TTot.o VMon.o ZDisc.o RunPedestals.o FinalTest.o ECAL.o CreateFECDocs.o FindNoise.o DACSweep.o LocalVMon.o TUBIIModel.o TUBIILink.o TUBIICmds.o

...
extern char DETECTOR_DB_NAME[100];
extern char DETECTOR_DB_HOST[100];
extern char DETECTOR_DB_PORT[100];
extern char DETECTOR_DB_USERNAME[100];
extern char DETECTOR_DB_PASSWORD[100];
